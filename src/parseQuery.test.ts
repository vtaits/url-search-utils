...
test("should exclude params", () => {
	const result = parseQuery(
		"include1=value1&include2=value2&excludeparam=test",
		{
...
test("should collect array of strings", () => {
	const queryString =
		"notarray1=value1&notarray2=value2&array=test&array=2&array=true";
...
test("should collect array of numbers", () => {
	const queryString =
		"notarray1=value1&notarray2=value2&array=3&array=1&array=4";
...
test("should apply function for serialize param to object", () => {
	const queryString =
		"nottest1=value1&nottest2=value2&test=3&test=1&test=4&test=1";

	const result = parseQuery(queryString, {
		test: (value, acc = {}) => {
			(acc as Record<string, number>)[value] =
				((acc as Record<string, number>)[value] || 0) + 1;
...
test("should throw an exception for unknown param type", () => {
	expect(() => {
		...
		parseQuery(queryString, {
			test: "test-type" as unknown as ParamType,
		});
